...
<link rel="stylesheet" type="text/css" href="css/frnd.css">
...
<div id="HeaderMain">
<img src="media/header_logo.png" width="300px"></img>
</div>

<div id="SmartScreenBorder">
	<img src="media/screen_border.png" width="310px"></img>
	<div id="SmartScreen" style = "background-color: #ED4A4A; ">
	...
	<!--Start Smart Screen-------->
		...
		<form method="post" action="" id="register-form">
			...
			<div id="LoginButtons" style="margin-left: 22%; width: 150px;" onClick="window.location = 'login.php';">< Back to Login</div>
