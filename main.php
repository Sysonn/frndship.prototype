...
<link rel="stylesheet" type="text/css" href="css/b.frnd.css">
...
<div id="ContentMain">
    ...
    <div id="FrndLogoB"><img src="media/browser-logo.png" width="150px"></img></div>
      ...
      <div id="SSBottomBar" style="background: #ED4A4A;">
		...
		document.getElementById('TopBarTitle').innerHTML = title;
			...
			<div id="idiv" src="profile.php" frameBorder="0" style="height: 100%; width: 100%; overflow: scroll; -webkit-overflow-scrolling: touch; overflow-x: hidden;"></div>
